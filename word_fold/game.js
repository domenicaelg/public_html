...
console.log("current words: " +curWords)
...
document.getElementById("words").innerHTML = "Words to spell: " + curWords.join(", ");
...
function on_click(x, y){
    ...
    if(CELLS[y][x].innerHTML == BOARDS[curBoard].words[0] && !gotWord[0]){
        ...
        // gotWord[0].classList.add(gotWord)
        
        document.getElementById("words").innerHTML = "Words to spell: " + BOARDS[0].curWords.join(", ");
    }
...
function changeBoard(newBoard){
    ...
    document.getElementById("words").innerHTML = "Words to spell: " + BOARDS[newBoard].words.join(", ");
...
function Restart(){
    ...
    document.getElementById("words").innerHTML = "Words to spell: " + BOARDS[curBoard].words.join(", ");
